...
http://localhost:3000
```
Into the project, there are HARDCODED credentials in order to easy test, but you can go to backend project [task-manager-backend](https://github.com/elkingiraldo/task-manager-backend) to search other users.
